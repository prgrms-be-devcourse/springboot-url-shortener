...
- [x] URL 입력폼 제공 및 결과 출력 <br> >> 리액트로 구현했습니다. [레포지토리 이동](https://github.com/Dev-Yesung/react-url-shortener)
...
- [x] Shortening Key를 생성하는 알고리즘 2개 이상 제공하며 애플리케이션 실행중 동적으로 변경 가능 (optional)<br> >> short UUID, Adler 알고리즘 추가
